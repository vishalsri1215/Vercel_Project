...
const faqData: FAQData = {
  'From this list, rank your 5 most favourite and 5 least favourite support tasks. Provide a brief explanation for each.': [
    {
      ...
      content: [
        'Work with engineering teams during incidents and provide updates to internal and external stakeholders - I like being able to control vital incidents. By dealing with engineers it’s easier to help each other solve any issue quickly enough. Providing updates to stakeholders creates an understanding atmosphere and transparency, particularly in the moments of tension. I am good at staying calm when things are tough, I also have strong communication abilities as well as cooperate with others effectively. These help me to perform this task effectively.',
        'Work with 3rd party partners to track down a tricky situation for a joint customer - I love to assist third-party partners in solving their customer’s problems. I derive motivation from doing detective work and problem-solving. Effective communication abilities as well as negotiation prowess are essential ingredients in this role. My delight comes from finding solutions that benefit everyone while at the same time cementing relationships between us.',
        'Manage a support team - When I manage a support team, I can mentor and improve the careers of other professionals. I lead through example and create a working environment that is characterized by teamwork and support. Through it too, I can establish techniques and plans that enhance the team’s efficiency levels and customer satisfaction rate. Additionally, it gives me the chance to directly contribute to the career advancement of persons in my team, something I find deeply rewarding.',
        'Write and maintain support articles and docs pages - One of my favorite activities is developing support documentation because it allows me to spread information and educate clients to deal with problems on their own. I document complex problem-solving techniques into plain directions that anyone can follow easily. In this way, support tickets will decrease and customers’ satisfaction level will go up as they have free guidance resources.',
        'Analyze hundreds of support tickets to spot trends the product team can use - Going through support tickets to find trends is something I enjoy because it makes me think and it impacts something. With spotting patterns or common problems, it gives the product team some good ideas for growth. A strategy that can be used to improve this product thereby reducing future customer inquiries. My communication skills, problem-solving abilities, team leadership competence, writing capacity, as well as data interpretation talent is what comes out conspicuously in this endeavor.',
      ],
    },
    {
      title: 'Top 5 Least Favorites',
      content: [
        'Respond to queries on Twitter, Reddit, Hacker News and other 3rd party sites - Even though it is necessary engage with consumers through social media and other external websites, I don’t feel it is very fulfilling for me mainly because these channels tend to be too risky and chatting on them is often without order. Due to their fast, ever-changing atmospheres, such platforms might sometimes require concise rather than detailed answers. Moreover, in some cases users’ identities are unknown resulting into loss or negative conversations noted here may drain much needed energy.',
        ...
        'Scheduling time-off coverage and collaborating as part of a growing cohesive support team -Although collaboration is important, it can be challenging to organize time-off coverage because there are often competing availability and preferences. In some situations, this might take a long time and derail us from doing other things like helping clients or enhancing the support system. Even as a team expands, strikes the crucial balance between morale and efficiency may sometimes prove a problem.',
        'Resolving billing issues is my least favorite task as a support engineer due to its complexity and sensitivity. It involves detailed investigations into billing discrepancies, handling common problems like incorrect charges or payment failures, and managing frustrated customers. This task requires balancing technical problem-solving with high-level customer service, often under stressful conditions. Ensuring customer satisfaction while making necessary billing adjustments and processing refunds is time-consuming and challenging. The intricacies of financial matters and the potential for customer dissatisfaction make this aspect of my role particularly taxing and unenjoyable.',
        'Find and recruit teammates for the support team - The process of hiring new team members is very important, but it’s not very stimulating for me because there’s so much administrative work and time required. My main duties are often neglected by going through resumes, interviewing candidates, and dealing with other aspects pertaining to the recruitment exercise. I often feel more fulfilled when I’m assisting clients directly & improving our customer service system instead of hiring new employees.',
      ],
    },
  ],
  'What do you want to learn or do more of at work?': 'I am passionate and excited about the realms of serverless computing and edge computing. I want a team that knows how to innovate upon itself, while also being open to contribution from anyone interested. I love integrating processes so that tasks are completed fast without compromising quality; thus making clients feel considered and taken care of but would be eager to take part in creating interior tools which give strength to support engineers still keeping the focus on customers. Intellectual curiosity, creativity, personal drive all are combined in me to find completely different ways out via cooperation, knowledge sharing and teamwork within such systems.',
  ...
  [
    {
      title: 'I would request the customer to provide detailed information about the issue to deep dive into the case ',
      content: [
  ...
  [
    {
      ...
      content: [
        'Hi [Customer name],',
        'My apologies for the inconvenience you are facing. It is possible for us to arrive at the cause of that problem easier and more accurately if we receive necessary data. Usually it’s about a certain setup or recent change in the code. Please assist us so that we find solutions more quickly and resolve this problem. We will help you as best as we can.',
        'Regards',
        'Vishal Srivastava'
      ],
    },
  ...
  [
    {
      ...
      content: [
        'Hi [Customer Name]',
        'There are some methods in which a site can be prevented from being indexed by search engines in Vercel.', 
  ...
  [
    {
      ...
      content: [
        ...
        'Short-term fix: Give step-by-step guides and detailed documentation that will aid in sorting ordinary deployment issues. To rapidly address urgent matters, provide online help through chat or email.',
        'Long-term fix: Create and maintain a full knowledge database containing solutions to problems frequently faced. Design automated tools for spotting and rectifying common deployment hitches before reaching clients. Organize recurrent online seminars plus educative courses aimed at teaching clients how to deploy and configure properly.'
      ],
    }
  ],
